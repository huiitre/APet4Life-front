...
const CGU = () => (
  <Page>
    <Segment className="mentions-legales">
      ...
      internet <a href="http://Aut est et sed culp">Aut est et sed culp</a> sont
      :
      <p>
        <span>
          <b>Editeur du Site : </b>
      ...
      Cumque illo quis sae Numéro de SIRET : Corrupti soluta sim Responsable
      editorial : Sit qui et dolorum i Non qui quo consequa Téléphone :+1 (368)
      501-9799 - Fax : +1 (708) 792-3907 Email : fufyzub@mailinator.com Site Web
      : <a href="http://Aut est et sed culp">Aut est et sed culp</a>
      <br />
      <p>
        <b>
      ...
      Hébergeur : Sit ullamco in sequ Suscipit cumque odit Site Web :
      <a href="http://Odit vel voluptas cu">Odit vel voluptas cu</a>
      <br />
      <p>
        <span>
          <b>Développement</b>
      ...
      Est qui consequatur Adresse : Numquam anim id dui Site Web :
      <a href="http://Do iusto non anim re">Do iusto non anim re</a>
      <br />
      <p>
        <span>
      ...
      Ce site (<a href="http://Aut est et sed culp">Aut est et sed culp</a>) est
      proposé en différents langages web (HTML, HTML5, Javascript, CSS, etc…)
      pour un meilleur confort d'utilisation et un graphisme plus agréable, nous
      vous recommandons de recourir à des navigateurs modernes comme Internet
      explorer, Safari, Firefox, Google Chrome, etc… Les mentions légales ont
      été générées sur le site
      <a
      ...
      .
      <span>
        Cumque illo quis sae<b> </b>
      </span>
      met en œuvre tous les moyens dont elle dispose, pour assurer une
      ...
      donc s'assurer de l'exactitude des informations auprès de , et signaler
      toutes modifications du site qu'il jugerait utile. n'est en aucun cas
      responsable de l'utilisation faite de ces informations, et de tout
      préjudice direct ou indirect pouvant en découler.
      <b>Cookies</b> : Le site
      <a href="http://Aut est et sed culp">Aut est et sed culp</a> peut-être
      ...
      Internet. Cumque illo quis sae ne dispose d'aucun moyen pour contrôler les
      sites en connexion avec ses sites internet. ne répond pas de la
      ...
      visiteurs des sites internet de ne peuvent mettre en place un hyperlien en
      direction de ce site sans l'autorisation expresse et préalable de Cumque
      illo quis sae. Dans l'hypothèse où un utilisateur ou visiteur souhaiterait
      mettre en place un hyperlien en direction d’un des sites internet de
      Cumque illo quis sae, il lui appartiendra d'adresser un email accessible
      sur le site afin de formuler sa demande de mise en place d'un hyperlien.
      Cumque illo quis sae se réserve le droit d’accepter ou de refuser un
      ...
      <p>
        Cumque illo quis sae s’efforce de fournir sur le site Aut est et sed
        culp des informations aussi précises que possible. les renseignements
        figurant sur le site
        <a href="http://Aut est et sed culp">Aut est et sed culp</a> ne sont pas
        ...
        Par ailleurs, tous les informations indiquées sur le site Aut est et sed
        culp
        <span>
          <b> </b>
        </span>
      ...
      bien vouloir le signaler par email, à l’adresse fufyzub@mailinator.com, en
      ...
      sauraient engager la responsabilité de Cumque illo quis sae.
      <br />
      <p>
        <span>
      ...
      <a href="http://Aut est et sed culp">Aut est et sed culp</a>, incluant, de
      ...
      interdite sans l'accord exprès par écrit de Cumque illo quis sae. Cette
      ...
      d'une déclaration Labore odit quo nesc auprès de la Commission nationale
      ...
      <a href="http://Aut est et sed culp">Aut est et sed culp</a> sont régies
      ...
      <a href="http://Aut est et sed culp">Aut est et sed culp</a>. Cependant,
      ce principe comporte certaines exceptions. En effet, pour certains
      services proposés par notre site, vous pouvez être amenés à nous
      ...
      lettres d’information. Enfin, nous pouvons collecter de manière
      automatique certaines informations vous concernant lors d’une simple
      navigation sur notre site Internet, notamment : des informations
      concernant l’utilisation de notre site, comme les zones que vous visitez
      et les services auxquels vous accédez, votre adresse IP, le type de votre
